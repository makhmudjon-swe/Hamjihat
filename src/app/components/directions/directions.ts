...
export class DirectionsComponent {
  protected readonly directions: ReadonlyArray<DirectionItem> = [
    ...
    },
    {
      ...
      description: "Suv, elektr va gaz loyihalarini baholang.",
      iconPath:
    ...
    },
    {
      ...
      description: "Parklar va yashil hududlar bo'yicha ishlarni kuzating.",
      iconPath:
    ...
    },
    {
      ...
      description: "Raqamlashtirish va IT loyihalarini kuzating.",
      iconPath:
